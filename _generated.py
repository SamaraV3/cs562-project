...
def query():
    ...
    S, n, V, F, o, G = (['cust', 'cust_sum_quant', 'cust_avg_quant', '1_sum_quant', '2_sum_quant', '3_sum_quant'], 3, ['cust'], [['1_sum_quant', '1_avg_quant'], ['2_sum_quant'], ['3_sum_quant', '3_avg_quant']], [["1.state='NY'"], ["2.state='NJ'"], ["3.state='CT'"]], '0')
    final_results = []
