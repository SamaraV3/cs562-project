...
def query():
    ...
    S, n, V, F, o, G = (['cust', '1_sum_quant', '2_sum_quant', '3_sum_quant'], 3, ['cust'], [['1_sum_quant'], ['2_sum_quant'], ['3_sum_quant', '3_avg_quant']], [["1.state='NY'"], ["2.state='NJ'", '2.quant>1_avg_quant'], ["3.state='CT'"]], '0')
    final_results = []
